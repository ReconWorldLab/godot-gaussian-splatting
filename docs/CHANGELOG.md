...
- Added headless CI tests for the Raster backend (counting-sort correctness, data-texture packing and FP16 round-trip) and the backend selector (fallback policy and guarded, decoupled loading).
